...
for s_num = 1:2
    ...
    for i = 1:my_length
        sTime = GetSecs;
        data.dat{s_num}{i}.text_start_time_stamp = sTime;
        ...
        data.dat{s_num}{i}.text_end_time_stamp = GetSecs;
        if duration(i,1) > 1
            ...
            data.dat{s_num}{i}.blank_end_time_stamp = GetSecs;
        end
        data.dat{s_num}{i}.text_end_time_stamp = GetSecs;
        if rem(i,5) == 0
