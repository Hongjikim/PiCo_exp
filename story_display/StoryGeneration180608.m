...
% ., 오류 시에는 curr story에 덮어쓰기 안되도록 구분!!!
...
save(data.datafile, 'data');
% text_file = [subjdate, '_Pilot_', subject_ID, '_', topic, '_run', sprintf('%.2d', run_number), '.txt'];
% save(text_file, 'doublestory')
